    ...
    with patch.dict(
        ...
        with patch("evaluate.get_logger") as mock_logger:
            ...
            with pytest.raises(ValueError, match="Could not load model"):
                evaluate.load_model_from_checkpoint(
                    "not_a_real_checkpoint.pth", {"input_size": 2}
                )
        ...
        with patch("evaluate.get_logger") as mock_logger:
            ...
            evaluate.load_dataset = Mock(return_value=(sample_x, sample_y))
