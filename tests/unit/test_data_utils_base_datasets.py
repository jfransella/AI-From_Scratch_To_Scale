...
class TestSyntheticDataset:
    ...
    def test_create_circles_dataset(self):
        ...
        dataset = create_synthetic_dataset(
            "circles", n_samples=200, data_dir=self.temp_dir
        )
    ...
    def test_create_linear_dataset(self):
        ...
        dataset = create_synthetic_dataset(
            "linear", n_samples=150, n_features=3, data_dir=self.temp_dir
        )
    ...
    def test_caching_functionality(self):
        ...
        dataset1 = create_synthetic_dataset(
            "xor", n_samples=50, data_dir=self.temp_dir, random_state=42
        )

        # Second creation with same parameters should use cache
        dataset2 = create_synthetic_dataset(
            "xor", n_samples=50, data_dir=self.temp_dir, random_state=42
        )
    ...
    def test_different_parameters_no_cache(self):
        ...
        dataset2 = create_synthetic_dataset(
            "xor", n_samples=100, data_dir=self.temp_dir, random_state=42
        )
...
class TestRealDataset:
    ...
    def test_dataset_splits(self):
        ...
        train_dataset = create_real_dataset(
            "iris_setosa_versicolor", split="train", data_dir=self.temp_dir
        )
        val_dataset = create_real_dataset(
            "iris_setosa_versicolor", split="val", data_dir=self.temp_dir
        )
        test_dataset = create_real_dataset(
            "iris_setosa_versicolor", split="test", data_dir=self.temp_dir
        )
...
class TestDatasetFactoryFunctions:
    ...
    def test_create_dataset_synthetic(self):
        ...
        dataset = create_dataset(
            "synthetic", "xor", n_samples=50, data_dir=self.temp_dir
        )
    ...
    def test_create_dataset_real(self):
        ...
        dataset = create_dataset(
            "real", "iris_setosa_versicolor", data_dir=self.temp_dir
        )
...
class TestDatasetInfo:
    ...
    def test_dataset_transforms(self):
        ...
        dataset = create_synthetic_dataset(
            "xor", n_samples=10, transform=dummy_transform, data_dir=self.temp_dir
        )
